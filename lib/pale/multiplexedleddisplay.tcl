...
class MultiplexedLedDisplay {
	...
	public common CONFMENU {
		{cascade	{Common electrode for digit}	7	"diode"		.cad	false 1 {
			{radiobutton	"Common anode"	{}
				::MultiplexedLedDisplay::cfg_common_anode_digit	1
				"common_electrode_changed"	7	""}
			{radiobutton	"Common cathode"	{}
				::MultiplexedLedDisplay::cfg_common_anode_digit	0
				"common_electrode_changed"	7	""}
		}}
		{cascade	{Common electrode for segment}	7	"diode"		.cas	false 1 {
			{radiobutton	"Common anode"	{}
				::MultiplexedLedDisplay::cfg_common_anode_segment	1
				"common_electrode_changed"	7	""}
			{radiobutton	"Common cathode"	{}
				::MultiplexedLedDisplay::cfg_common_anode_segment	0
				"common_electrode_changed"	7	""}
		}}
	...
	private variable common_anode_digit	1	;# Bool: 1 == common anode; 0 == common cathode
	private variable common_anode_segment	1	;# Bool: 1 == common anode; 0 == common cathode
	...
	public method common_electrode_changed {} {
		set common_anode_digit ${::MultiplexedLedDisplay::cfg_common_anode_digit}
		set common_anode_segment ${::MultiplexedLedDisplay::cfg_common_anode_segment}
...
# 		11 11	11 15	11 11	15 11	11 11
	...
	public method new_state {_state {preserve_prvious_state 0}} {
		...
		for {set i 0} {$i < 8} {incr i} {
			...
			for {set j 0} {$j < 4} {incr j} {
				...
				switch -- $state_pp {
					{0} {	;# Logical 0
						if {$common_anode_segment} { #$common_anode
							switch -- $t_state($j) {
								{2} {
									set segment_color {2}
								}
	...
	public method set_config {state} {
		if {[catch {
			...
			set common_anode_digit	[lindex $state 6]
			if {$common_anode_digit == {}} {
				set common_anode_digit 1
			}

			set common_anode_segment	[lindex $state 7]
			if {$common_anode_segment == {}} {
				set common_anode_segment 1
			}
	...
	public method config_menu_special {} {
		...
		set ::${class_name}::cfg_common_anode_digit $common_anode_digit
		set ::${class_name}::cfg_common_anode_segment $common_anode_segment
